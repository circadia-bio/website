    ...
    <div class="nc-track">
      ...
      <div class="nc-slide nc-active">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">Validation of ActTrust&#174; against GT3X+ using indirect calorimetry in 56 young adults. Balanced accuracies above 0.77 across all intensity ranges. <em>PLOS ONE</em>, 2026.</p>
        </div>
      </div>
      ...
      <div class="nc-slide nc-slide-flip">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">72% of blind adults near the equator showed stable circadian entrainment without photic input, suggesting environmental regularity supports non-photic synchronisation. <em>bioRxiv</em>, 2026.</p>
        </div>
      </div>
      ...
      <div class="nc-slide">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">Six transient brain connectivity states identified at birth in 390 neonates. Preterm infants show atypical patterns linked to social and sensory behaviours at 18 months. <em>Nature Communications</em>, 2024.</p>
        </div>
      </div>
      ...
      <div class="nc-slide nc-slide-flip">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">Recurrence entropy of EEG signals is lower during cycling than at rest across all brain regions, reflecting reduced complexity from repetitive sensorimotor feedback. <em>PLOS ONE</em>, 2024.</p>
        </div>
      </div>
      ...
      <div class="nc-slide">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">Genetic factors explain 18&#8211;38% of variance in non-REM sleep stages and apnoea-hypopnoea index in 648 participants from the Baependi Heart Study. <em>Journal of Sleep Research</em>, 2024.</p>
        </div>
      </div>
      ...
      <div class="nc-slide nc-slide-flip">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">40.6% of 165 haemodialysis patients showed chronodisruption; morning chronotype was significantly more prevalent than in the general population. <em>Chronobiology International</em>, 2024.</p>
        </div>
      </div>
      ...
      <div class="nc-slide">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">14 days of blue light therapy increased amplitude, rhythmic robustness, and rest-phase consolidation in aged rats, suggesting a potential therapy for age-related circadian dysfunction. <em>PLOS ONE</em>, 2023.</p>
        </div>
      </div>
      ...
      <div class="nc-slide nc-slide-flip">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">Sleep efficiency and medication use predicted depression severity, discriminating mild from treatment-resistant depression across 107 participants. <em>Current Psychology</em>, 2024.</p>
        </div>
      </div>
