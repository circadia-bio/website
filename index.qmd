...
<p class="nc-journal"><em>PLOS ONE</em> &middot; 2026</p>          <p class="nc-desc">Validation of the ActTrust® actigraphy device against the ActiGraph® GT3X+ and indirect calorimetry in 56 young adults. Derives the first published cut-points for physical activity intensity classification using ActTrust® at hip and wrist placements.</p>
        </div>
      </div>
...
<p class="nc-journal"><em>Sleep and Vigilance</em> &middot; 2025</p>          <p class="nc-desc">The first systematic review of chronotype profiling in children aged 0–10 years, conducted following PRISMA guidelines across five databases. The review finds inconsistent evidence on whether morning chronotype predominates in children, highlights the heterogeneity of measurement approaches used across studies, and identifies key gaps in the literature on circadian preference in early childhood.</p>
        </div>
      </div>
