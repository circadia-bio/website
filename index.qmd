    ...
    <div class="nc-track">
      ...
      <div class="nc-slide">
        ...
        <div class="nc-body">
          ...
          <p class="nc-desc">L5 onset correlates significantly with mid-sleep point across 502 nights from 81 six-month-old infants, supporting it as a practical, non-invasive circadian phase marker in early childhood.</p>
        </div>
      </div>

      <div class="nc-slide nc-slide-flip">
        <a href="publications/silva2025/index.html" class="nc-image"><img src="publications/silva2025/featured.png" alt="Chronotype Profile in Children"></a>
        <div class="nc-body">
          <div class="nc-label-row"><span class="nc-label">Publications</span><a href="publications.html" class="news-see-all">See all</a></div>
          ...
          <p class="nc-desc">The first systematic review of chronotype profiling in children aged 0–10 years. Finds inconsistent evidence on whether morning chronotype predominates, and highlights heterogeneity of measurement approaches across studies.</p>
        </div>
      </div>

      <div class="nc-slide">
        <a href="publications/palombini2024/index.html" class="nc-image"><img src="publications/palombini2024/featured.jpg" alt="PSG Standardization Brazil"></a>
        <div class="nc-body">
          <div class="nc-label-row"><span class="nc-label">Publications</span><a href="publications.html" class="news-see-all">See all</a></div>
          ...
          <p class="nc-desc">Consensus guidelines for PSG reporting covering scoring rules, technical specifications, and reporting conventions to improve consistency across Brazilian clinical and research sleep studies.</p>
        </div>
      </div>
